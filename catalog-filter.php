        ...
        <div class="row">
            <aside class="main-sidebar col-xs-12 col-sm-3">
                <div class="module menu-module">
                    ...
                    <ul>
                        <li>
                            <a href="#">Психо-соматическое состояние</a>
                            <ul>
                                <li class="active">
                                    <a href="#">Гипертония</a>
                                </li>
                        ...
                        <li>
                            <a href="#">Система кровообращения и лимфообращения</a>
                        </li>
                        <li>
                            <a href="#">Состояние кровеносных сосудов</a>
                        </li>
                        <li>
                            <a href="#">Имунная система</a>
                        </li>
                        <li>
                            <a href="#">Гормональный баланс</a>
                        </li>
                        <li>
                            <a href="#">Репродуктивная система</a>
                        </li>
                        <li>
                            <a href="#">Опорно-двигательный аппарат</a>
                        </li>
                        <li>
                            <a href="#">Биохимический обмен веществ</a>
                        </li>
                        <li>
                            <a href="#">Состояние кожных покровов</a>
                        </li>
                        <li>
                            <a href="#">Дерматология</a>
                        </li>
                        <li>
                            <a href="#">Лечение открытых ран, ожогов</a>
                        </li>
                    </ul>
                </div>
