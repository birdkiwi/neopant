                ...
                <div class="main-content-main col-xs-12 col-sm-9">
                    ...
                    <div class="catalog-block">
                        <article class="catalog-block-desc">
                            ...
                            <p>В разработке серии ПАНТОВЫЙ ГЕЛЬ НЕОПАНТ и клинических апробациях принимали участие Научно- Исследовательский Институт Клинической Иммунологии СО РАМН, ЗАОСанаторий «Россия», ОАО Санаторий «Алтай– West», МУ Санаторий Центросоюза РФ, ИП Григорьев Е.А..</p>

                            <p>Проведенные клинические испытания подтвердили профилактическо — оздоровительные эффекты и косметические свойства препарата. Инновационные формулы препаратов серии ПАНТОВЫЙ ГЕЛЬ НЕОПАНТ запатентованы – патент РФ № 2324473.</p>
                        </article>

                        <div class="catalog-block-categories">
                            <div class="row">
                                <div class="col-xs-12 col-sm-4">
                                    <div class="catalog-block-categories-item">
                                        <div class="catalog-block-categories-item-image">
                                            <a href="#">
                                                <img src="images/tmp/category-1.jpg" alt="">
                                            </a>
                                        </div>
                                        <h3 class="catalog-block-categories-item-name">
                                            <a href="#">Пантовые ванны для рук</a>
                                        </h3>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <div class="catalog-block-categories-item">
                                        <div class="catalog-block-categories-item-image">
                                            <a href="#">
                                                <img src="images/tmp/category-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <h3 class="catalog-block-categories-item-name">
                                            <a href="#">Препараты для коррекции половой дисфункции</a>
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <div class="catalog-block-categories-item">
                                        <div class="catalog-block-categories-item-image">
                                            <a href="#">
                                                <img src="images/tmp/category-3.jpg" alt="">
                                            </a>
                                        </div>
                                        <h3 class="catalog-block-categories-item-name">
